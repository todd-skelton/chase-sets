...
- Fulfillment baseline: `docs/domain/fulfillment-shipping-and-fulfillment-mvp.md`
- Money math invariants: `docs/domain/payments-money-math-fees-shipping-credit-and-ledger-invariants.md`
