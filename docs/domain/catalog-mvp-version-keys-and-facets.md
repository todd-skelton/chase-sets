...
- Version identity + VersionPath normalization: [catalog-version-identity-and-resolution.md](catalog-version-identity-and-resolution.md)
- Glossary definitions: [glossary.md](glossary.md)
- Version system principles: [catalog-version-system.md](catalog-version-system.md)
...
- **Sortable choices**: options/option values must support admin-authored ordering for UI/filter display (presentation-only; see [catalog-version-system.md](catalog-version-system.md)).
...
- Machine-readable error codes (see [catalog-version-identity-and-resolution.md](catalog-version-identity-and-resolution.md))
...
See: [catalog-version-identity-and-resolution.md](catalog-version-identity-and-resolution.md)
...
More complete examples (JSON-ish): [catalog-version-model-examples.md](catalog-version-model-examples.md)
