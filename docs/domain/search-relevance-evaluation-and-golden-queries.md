...
- Common nicknames/aliases:
  - â€œshiny charizardâ€, â€œalt artâ€, â€œpromo pikachuâ€
- Attribute-driven queries:
  - â€œPSA 10â€, â€œJapaneseâ€, â€œfirst editionâ€
- Misspellings/typos
...
- â€œMust-notâ€ results (common confusions)
...
The canonical â€œtop queries we must nailâ€ list lives in `docs/domain/search-filtering-requirements.md`.
...
|  15 | `charzard`                          | Charizard                                   | â€œCharizard exâ€ only           | Misspelling             |
...
|  20 | `chase card`                        | High-interest â€œchaseâ€ items (policy-driven) | Random low-value commons      | Explicit semantic query |
...
- Search â†’ click-through rate
- Search â†’ add-to-cart rate
