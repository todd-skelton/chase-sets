# Marketplace Domain â€” TODOs (Build Checklist)

This checklist is the drill-down work plan for Marketplace.

## Inputs / dependencies

- Matching baseline: `docs/adrs/003-bids-listings-and-matching.md`
- Single checkout split constraint: `docs/adrs/017-single-charge-multi-seller-split.md`
...
- [ ] Define the minimum fields for a â€œtrade executionâ€ (price, quantity, fees allocation references)
...
- [ ] Define what is â€œreservedâ€ when a match is pending payment (if anything)
...
- [ ] Define â€œbuy nowâ€ semantics as a deterministic transformation to a bid/listing
...
- [ ] Define â€œrecent salesâ€ projection per SKU (supports price history)
