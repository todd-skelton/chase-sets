...
## Purpose
Define payments-specific terms not already canonicalized in `../../../docs/domain/glossary.md`.
...
- `21-disputes-refunds-chargebacks-and-ledger-unwind.md`
- `31-money-math-fees-shipping-credit-and-ledger-invariants.md`